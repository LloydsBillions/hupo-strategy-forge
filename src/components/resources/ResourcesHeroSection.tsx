...
const ResourcesHeroSection = () => {
  ...
  return (
    <section ref={ref} className="relative bg-obsidian py-32 md:py-40 overflow-hidden noise-overlay">
      ...
      <div className="absolute top-1/2 right-10 w-1 h-24 bg-primary/30" />
      ...
      <div className="container-wide relative z-10">
        ...
        <div className="max-w-4xl">
          ...
          {/* Headline */}
          <h1 className={cn(
            "text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-display font-black text-white leading-none mb-6 break-words opacity-0",
          ...
          <p className={cn(
            ...
            Deep insights on strategic thinking, decision-making, and execution from the Hupo faculty and community.
          </p>
        </div>
      </div>
