    ...
    <section className="relative min-h-screen flex items-center justify-center bg-obsidian overflow-hidden">
      ...
      <div className="container-wide relative z-10 pt-24">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            Africa's first School of Strategic Thought—where leaders pause the noise to reconstruct how they think,
            decide, and act.
          </p>
      ...
      >
        <span className="text-[10px] sm:text-xs uppercase tracking-wider hidden sm:block">Scroll to Discover</span>
